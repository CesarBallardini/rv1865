...
\input Romantik.fd
\newcommand*\lettrinefont{\usefont{U}{Romantik}{xl}{n}}
...
\setmainfont[RawFeature={+dlig},ItalicFeatures={CharacterVariant=5:2}]{EB Garamond}
...
\newcommand{\bbooknog}[3][]{%
  \chapter[#1]{#2\\\large \\\char"2766}
}
